...
Consulte o [cheatsheet](https://www.raylib.com/cheatsheet/cheatsheet.html). Lá há diversas outras funções para detecção de colisões entre outras formas (círculos, linhas, pontos, etc.).
